...
INSERT INTO MYMEMBER
VALUES(MYMEMBERSEQ.NEXTVAL, 'system', 'oracle', '맥디비', '서버', '010-1111-1111', 'system@admin.com', 'Y', 'USER');

INSERT INTO MYMEMBER
VALUES(MYMEMBERSEQ.NEXTVAL, 'kh', 'kh', '윈도우디비', '서버', '010-2222-2222', 'kh@admin@com', 'N', 'USER');
